  ...
  return (
    <>
      ...
      <Amenity/> 
        ...
        <p className="mx-11 text-primary font-semibold text-2xl dark:text-[#CBB7A4]">Filter by</p>
          ...
          <div className="mx-10 mt-4">
            ...
            <div className="flex space-x-3 mt-8">
              <div className="w-28 h-14 bg-white border border-custom p-1 rounded dark:bg-transparent dark:border-[#DBD6D3]">
                <label htmlFor="minInput" className="font-semibold dark:text-[#DDD1C5]">
                  Min
                </label>
                <input
                  type="text"
              ...
              <div className="w-28 h-14 bg-white border border-custom p-1 rounded-lg   dark:bg-transparent dark:border-[#DBD6D3]">
                <label htmlFor="maxInput" className="font-semibold dark:text-[#DDD1C5]">
                  Max
                </label>
                <input
                  type="text"
